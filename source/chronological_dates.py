...
sys.path.append(
    "/home/gabxetc/Documents/solutions/alphabetDate"
)  # Replace this path with your project's root path
...
def select_list():
    choose_list = (
        input("Which list of dates would you list to search? ").lower().strip()
    )
